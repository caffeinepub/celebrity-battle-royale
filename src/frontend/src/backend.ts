...
export class Backend implements backendInterface {
    ...
    async getCharacterById(arg0: bigint): Promise<Character | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCharacterById(arg0);
    ...
    async getLeaderboard(): Promise<Array<PlayerRanking>> {
        if (this.processError) {
            try {
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Character]): Character | null {
